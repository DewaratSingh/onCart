    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
          ...
          <button onClick={()=>{router.push("/pages/admin/Dashbord")}} className="w-full mt-6 border-indigo-500 border-2 hover:bg-[#442dd72e] text-black font-medium py-2.5 rounded-lg transition-colors">
            Cancle
          </button>
        </div>
      </div>
